...
public class DocumentMethodAnnotation {
    ...
    /**
     * The template this specific method should use. If this is <tt>null</tt>, this
     * will use the template defined by the \"-template\" argument.
     * 
     ...
     * For example: <code>commandGetNodeInfo</code> and the displayed name
     * <code>getNodeInfo</code>
     */
    ...
    /**
     * The name of this command as displayed in the response Only if
     * {@link #hasParam()} returns true
     * 
     * @return
     */
